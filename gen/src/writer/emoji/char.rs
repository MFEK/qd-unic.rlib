...
pub fn generate(dir: &Path) {
    ...
    emit_emoji_extended_pictographic(dir);
}
...
pub fn emit_emoji_extended_pictographic(dir: &Path) {
    write(
        dir,
        "emoji_extended_pictographic.rsv",
        &EMOJI_DATA.emoji_extended_pictographic.to_range_char_set(),
    );
}
